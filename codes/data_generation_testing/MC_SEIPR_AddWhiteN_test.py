...
def save_csv(i, df_ews, sim_index,regime): 
    ...
    filepath_ews = f'./SEIPR_AddNoise/data/ews/df_ews_SEIPR_MultNoise_{regime}.csv'
    ...
    filepath_resids = f'./SEIPR_AddNoise/data/resids/resids_SEIPR_AddNoise_{regime}{sim_index+i}.csv'
...
if not os.path.exists('./SEIPR_AddNoise/data/ews'):
    os.makedirs('./SEIPR_AddNoise/data/ews')

if not os.path.exists('./SEIPR_AddNoise/data/resids'.format(count)):
    os.makedirs('./SEIPR_AddNoise/data/resids'.format(count))
